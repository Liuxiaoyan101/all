...
import com.example.lxyshop.bean.UserInfo;
import com.example.lxyshop.database.UserDBHelper;
import com.example.lxyshop.util.DateUtil;
import com.example.lxyshop.util.ViewUtil;


public class MainMenu extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener , CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // rg_login.setOnCheckedChangeListener(new RadioListener());
        ...
        //ck_remember.setOnCheckedChangeListener();
        ...
        refreshResult(ck_remember);//自己写的
    ...
    private String[] typeArray = {"普通会员", "高级会员","超级会员"};
    ...
    private class RadioListener implements RadioGroup.OnCheckedChangeListener {
        ...
        public void onCheckedChanged(RadioGroup group, int checkedId) {
            ...
            if (checkedId == R.id.rb_password) { // 选择了密码登录
                ...
                refreshResult(ck_remember);//自己加的
    ...
    private class HideTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if ((mStr.length() == 11 && mMaxLength == 11) ||
                ...
                ViewUtil.hideOneInputMethod(MainMenu.this, mView);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btn_forget) { // 点击了“忘记密码”按钮
            ...
            if (rb_password.isChecked()) { // 密码方式校验
                ...
                if (info != null) {
                    // 输入的密码和数据库储存的比较
                    if (!et_password.getText().toString().equals(info.phonepwd)) {
    ...
    private void loginSuccess() {
        ...
        if (bRemember) {
            ...
            info.phonenumber = et_phone.getText().toString();
            info.phonepwd = et_password.getText().toString();
        ...
        builder.setPositiveButton("确定登录", new DialogInterface.OnClickListener() {
        ...
        if (v.getId() == R.id.et_password) {
            ...
            if (phone.length() > 0 && hasFocus) {
                ...
                if (info != null) {
                    ...
                    // et_password.setText(info.phonepwd);
                    mPassword = info.phonepwd;
                }
